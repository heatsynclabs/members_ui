...
import { combinedHandler, resetReducer, reset, makeDuck } from 'cooldux';
...
export const { getAll, getOne, emailLogin, oauthStart, getNewSignups, verify, tokenLogin, validate, signup, passwordReset, updatePassword, reducerCombined, initialStateCombined } = duck;
...
const reducer = resetReducer(Object.assign({},initialStateCombined, isc2), function(state, action) {
